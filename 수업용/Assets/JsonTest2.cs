...
public class JsonTest2 : MonoBehaviour
{
    ...
    public void Load()
    {
        ...
        //if(objs.gameObjDatas.Count > targetlist.Count)
        //{
        ...
        //else
        //{
        //    for (int i = 0; i < objs.gameObjDatas.Count && i < targetlist.Count; i++)
        //    {
        //        var obj = objs.gameObjDatas[i];
        //        targetlist[i].transform.position = obj.position;
        //        targetlist[i].transform.rotation = obj.rotation;
        //        targetlist[i].transform.localScale = obj.localscale;
        //    }
        //}
    }
